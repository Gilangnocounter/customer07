...
let settings = {
    music: 'music/riskitall.mp3',
    countdown: 3,
    matrixText: 'HAPPY BRTHDAY',
    matrixColor1: '#ff69b4', // Màu pink mẫu
    matrixColor2: '#ff1493', // Màu pink mẫu
    sequence: 'HAPPY|BIRTHDAY|NURRIQAH|FITRI|❤',
    ...
    pages: [
        ...
        { 
            ...
            content: 'WAKE UP BABYYYYYY! IT\'S YOUR BIRTHDAY!!'
        },
        ...
        { 
            ...
            content: 'Selamat ulangtahun sayangku cintaku my honey bany sweetieku🤍' 
        },
        ...
        { 
            ...
            content: 'semoga sehat selalu, dimurahkan rezekinya, dimudahkan dalam segala hal termasuk apa yg lagi ditargetkan semoga tercapai ya sayang, semoga lancar luncur buat sempro nya sayang🫂🤍' 
        },
        ...
        { 
            ...
            content: 'i love u on your birthday and everyday, now and forever🤍🤍🫂' 
        },
    ],
    enableBook: true,
    enableHeart: true,
